...
/**
 * ProduceTestResultServiceHandler<p/>Result produce service<p/>
 *
 * @version 1.0
 * @author Steffen Schmidt, PRODYNA AG, 2010-10-05
 */
public abstract class ProduceTestResultServiceHandler extends PersistenceServiceHandlerSupport implements
     ...
     */
    protected ServiceResponse<TestResultMsg> invoke(ServiceRequest<EmptyServiceMessage> rq) throws ProduceException {
     ...
     * @throws ProduceException
     */
    protected abstract TestResultMsg produceTestResult(EmptyServiceMessage msg) throws ProduceException;
