...
/**
 * CreateIssueServiceHandler<p/>Jira export service<p/>
 *
 * @version 1.0
...
public abstract class CreateIssueServiceHandler extends PersistenceServiceHandlerSupport implements ServiceHandler,
    ...
    private static final String ID = "org.nabucco.testautomation.result.impl.service.jira.CreateIssueServiceHandler";

    /** Constructs a new CreateIssueServiceHandler instance. */
    public CreateIssueServiceHandler() {
        super();
    }
    ...
    protected ServiceResponse<IssueMsg> invoke(ServiceRequest<IssueMsg> rq) throws MaintainException {
        ...
        try {
            ...
            msg = this.createIssue(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     * @throws MaintainException
     */
    protected abstract IssueMsg createIssue(IssueMsg msg) throws MaintainException;
