...
public class ProjectListMsg extends ServiceMessageSupport implements ServiceMessage {
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.put(PROJECTS, PropertyDescriptorSupport.createCollection(PROJECTS, Project.class, 0,
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(ProjectListMsg.getPropertyDescriptor(PROJECTS), this.projects));
        return properties;
    }
