 ...
 */
public class ScreenshotDetailPageView extends TestautomationDetailPageView<TestConfigurationResultMaintenanceMultiPageEditViewModel> {

	/**
	 * Creates a new {@link ScreenshotDetailPageView} instance.
	 * 
	 * @param block
	 ...
	 */
	public ScreenshotDetailPageView(MasterDetailBlock<TestConfigurationResultMaintenanceMultiPageEditViewModel> block,
	 ...
	 */
	public ScreenshotDetailPageView(
	...
	protected GeneralDetailPageViewLayouter getLayouter(String title) {
		return new ScreenshotDetailPageViewLayouter(title);
	}
