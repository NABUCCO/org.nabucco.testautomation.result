...
import org.nabucco.testautomation.result.ui.rcp.multipage.result.maintenance.jiraexport.wizard.pages.tree.TestResultTreeContentProvider;
import org.nabucco.testautomation.result.ui.rcp.multipage.result.maintenance.jiraexport.wizard.pages.tree.TestResultTreeLabelProvider;


/**
 * TestResultSelectionPage
 * 
 * @author Markus Jorroch, PRODYNA AG
 */
public class TestResultSelectionPage extends WizardPage {

	public static final String ID = "org.nabucco.testautomation.result.ui.rcp.multipage.result.maintenance.jira.wizard.TestResultSelectionPage";
	 ...
	 */
	public TestResultSelectionPage(JiraExportWizardModel wizardModel) {
	...
	public void createControl(Composite parent) {
		...
		this.treeViewer.setContentProvider(new TestResultTreeContentProvider(this.wizardModel.getTestConfigurationResult()));
			...
			public void checkStateChanged(CheckStateChangedEvent arg0) {
				...
				for (Object object : checkedElements) {
					if(object instanceof TestResultContainer && isExportAllowed((TestResultContainer) object)){
						wizardModel.addSelectedTestResult(((TestResultContainer) object).getResult());
					}
				}
		...
		this.treeViewer.setInput(new Object[]{this.wizardModel.getTestConfigurationResult()});
	...
	private List<TestResultContainer> getErroneousTestResults() {
		List<TestResultContainer> testResultList = this.wizardModel.getTestConfigurationResult().getTestResultList();
