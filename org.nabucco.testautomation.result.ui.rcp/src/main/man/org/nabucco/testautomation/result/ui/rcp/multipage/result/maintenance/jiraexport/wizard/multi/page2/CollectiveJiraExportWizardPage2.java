...
*/
package org.nabucco.testautomation.result.ui.rcp.multipage.result.maintenance.jiraexport.wizard.multi.page2;
 ...
 */
public class CollectiveJiraExportWizardPage2 extends WizardPage {

	public static final String ID = "org.nabucco.testautomation.result.ui.rcp.multipage.result.maintenance.jira.wizard.CollectiveJiraExportWizardPage2";
	 ...
	 */
	public CollectiveJiraExportWizardPage2(CollectiveJiraExportWizardModel collectiveJiraExportWizardModel) {
	...
	public void createControl(Composite parent) {
		...
		List<Project> projects = this.collectiveJiraExportWizardModel.getJiraAdapterConnector().getAvailableProjects();
		...
		this.projectCombo.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent arg0) {
				...
				collectiveJiraExportWizardModel.setProject(project);
				issueTypeCombo.setEnabled(false);
				List<IssueType> issueTypes = collectiveJiraExportWizardModel.getJiraAdapterConnector().getIssueTypesForProject(project);
				...
				issueTypeCombo.setEnabled(true);
			}
		...
		this.issueTypeCombo.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent arg0) {
				...
				collectiveJiraExportWizardModel.setIssueType(issueType);
