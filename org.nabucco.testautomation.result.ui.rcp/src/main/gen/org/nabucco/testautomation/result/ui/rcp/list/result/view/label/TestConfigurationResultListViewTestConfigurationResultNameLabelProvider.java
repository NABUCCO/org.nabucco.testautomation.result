 ...
 * @author Undefined
 */
public class TestConfigurationResultListViewTestConfigurationResultNameLabelProvider implements ILabelProvider {
    ...
    public String getText(Object arg0) {
        ...
        if ((arg0 instanceof TestConfigurationResult)) {
            ...
            result = ((testConfigurationResult.getName() != null) ? testConfigurationResult.getName().toString() : "");
        }
        return result;
    }
